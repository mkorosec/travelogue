    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex gap-3 mt-5">
          <button
            onClick={onCancel}
            className="flex-1 px-4 py-2.5 rounded-xl bg-[var(--color-travel-surface-hi)] text-slate-300 hover:bg-[var(--color-travel-border-hi)] text-sm font-semibold transition-colors"
          >
            Cancel
          </button>
          <button
