    ...
    <div className="space-y-4">
      <div className="space-y-3">
        <div className="flex items-baseline justify-between">
          ...
          >
            {visitedCount}
            <span className="text-base font-normal text-slate-400"> / {totalCountries}</span>
          </motion.span>
        ...
        <div className="flex gap-4 text-sm">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-slate-400">{visitedCount} visited</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-2.5 h-2.5 rounded-sm bg-amber-500" />
            <span className="text-slate-400">{wantCount} want to go</span>
          </div>
        </div>
      </div>

      <div className="space-y-2.5">
        <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">By continent</h4>
  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div className="flex-1 min-w-0 flex items-center gap-2">
        ...
        <span className="text-xs text-slate-500 tabular-nums flex-shrink-0 w-8 text-right">{visited}</span>
      </div>
    </div>
  )
}
