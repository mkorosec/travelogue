export const NUMERIC_TO_A3 = {
  ...
  "926": "XKX", "414": "KWT", "417": "KGZ", "418": "LAO", "428": "LVA",
...
export function numericToA3(numericId) {
  const str = typeof numericId === "number" ? String(numericId).padStart(3, "0") : String(numericId)
  return NUMERIC_TO_A3[str] || null
}
